...
class AiStudyActionService:
    ...
    def tool_definitions() -> list[dict]:
        ...
        return [
            ...
            {"type": "function", "function": {"name": "create_flashcards", "description": "Generate and save study flashcards in an existing folder. Use the selected folder when no folder is supplied; otherwise pass the existing folder name. If the user has not identified a folder, ask which existing folder to use.", "parameters": {"type": "object", "properties": {"topic": {"type": "string"}, "count": {"type": "integer", "minimum": 1, "maximum": 25}, "folder_id": {"type": "string"}, "folder_name": {"type": "string"}}, "required": ["topic", "count"], "additionalProperties": False}}},

...
import { DURATION_PRESETS, INTERVAL_PRESETS } from "../../constants";
...
const styles = StyleSheet.create({
  wrap: { flex: 1 },
  heading: { fontSize: 18, fontWeight: "700", color: THEME.textWhite, marginBottom: 16 },
  label: {
  ...
  radioOuter: {
    ...
    borderColor: THEME.borderBright, justifyContent: "center", alignItems: "center",
  },
  ...
  timeBtn: {
    backgroundColor: THEME.bgElevated, borderRadius: THEME.radiusMd,
    paddingVertical: 16, alignItems: "center", borderWidth: 1, borderColor: THEME.borderBright,
  },
  ...
  shuffleRow: {
    ...
    backgroundColor: THEME.bgElevated, borderRadius: THEME.radiusMd,
    padding: 14, marginTop: 6, borderWidth: 1, borderColor: THEME.borderBright,
  },
